        ...
        <div class="col-lg-4 mt-5 mt-lg-0 d-flex align-items-stretch">
          <form method="POST">
            <div class="form-row">
              ...
              <div class="col-lg-8a mt-5 mt-lg-0 d-flex align-items-stretch">
            ...
            <div class="text-center"> <br> <button type="submit" class="btn btn-secondary" name="submit">Connexion</button><br>
